...
#define SERIAL_DEBUG_BAUD          921600 //        9600, n. Where n=9600,19200,57600,115200 (common baud rates.)             Option
...
// PASSWORD ------------------------------------------------------------------------------------------------------------------------
#define PASSWORD_DEFAULT       "Omicron$Persei$TS!" //  "password", Adjust as required, this can be changed at runtime also.            Adjust
...
#define BLE_GP_ADDR   "ff:23:10:10:80:58" // ...f:ff:ff", GamePad MAC address #1                                              Adjust
...
#define MDNS_NAME             "RoboScope" //   "onstep",  mDNS device name.                                                   Adjust
...
#define AP_SSID               "RoboScope" //    "ONSTEP", Wifi Access Point SSID.                                             Adjust
#define AP_PASSWORD  "Omicron$Persei$TS!" //  "password", Wifi Access Point password.                                         Adjust
#define AP_CHANNEL                      7 //           7, Wifi Access Point channel.                                          Adjust
#define AP_IP_ADDR      {192,168,111,140} // ..,168,0,1}, Wifi Access Point IP Address.                                       Adjust
#define AP_GW_ADDR        {192,168,111,1} // ..,168,0,1}, Wifi Access Point GATEWAY Address.                                  Adjust
...
#define STA_SSID                   "Lrrr" //      "Home", Wifi Station SSID to connnect to.                                   Adjust
#define STA_PASSWORD  "Omicron$Persei$8!" //  "password", Wifi Station mode password.                                         Adjust
#define STA_DHCP_ENABLED             true //       false, Wifi Station/Ethernet DHCP Enabled.                                 Adjust
#define STA_IP_ADDR     {192,168,111,140} // ..168,1,55}, Wifi Station/Ethernet IP Address.                                   Adjust
#define STA_GW_ADDR       {192,168,111,1} // ..,168,1,1}, Wifi Station/Ethernet GATEWAY Address.                              Adjust
